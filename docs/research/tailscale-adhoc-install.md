...
all URLs in them absolute `https://homeserver.tail7ee158.ts.net/...`. The
...
already enabled tailnet-wide (`tail7ee158.ts.net`); whether the **HTTPS
    ...
    <dict>
      ...
      <array>
        <dict>
          ...
          <key>url</key>
          <string>https://homeserver.tail7ee158.ts.net/HeartRateBLE.ipa</string>
        </dict>
      </array>
      <key>metadata</key>
      <dict>
...
```html
<a href="itms-services://?action=download-manifest&url=https://homeserver.tail7ee158.ts.net/manifest.plist">
...
<p><a href="itms-services://?action=download-manifest&url=https://homeserver.tail7ee158.ts.net/manifest.plist">
  Tap to install
</a></p>
```
...
`https://homeserver.tail7ee158.ts.net/` in Safari or Chrome, tap the
...
be the absolute `https://homeserver.tail7ee158.ts.net/...` forms.
